...
const ChatGptDocs: React.FC = () => {
  ...
  const basicSetupCode = `import { ChatGPT } from 'macro_api';
...
async function simpleChat() {
  ...
  const advancedCode = `// Advanced chat completion with full control
  ...
  const features = [
    {
      ...
      description: 'Generate conversational AI responses with various models',
      icon: <MessageSquare className="h-4 w-4" />
    },
    {
      name: 'Function Calling',
      description: 'Allow AI to call external functions and tools',
      icon: <Zap className="h-4 w-4" />
    },
    {
      name: 'Streaming Responses',
      description: 'Real-time response streaming for better UX',
      icon: <Database className="h-4 w-4" />
    },
    {
      name: 'Embeddings',
      description: 'Create semantic embeddings for search and similarity',
      ...
      <div className="relative z-10 container-responsive section-padding">
        ...
        <div className="text-center section-margin-sm">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-8">
            <span className="glass px-3 py-1.5 rounded-full text-sm font-medium text-green-600 dark:text-green-400 border border-green-500/20">Chat Completions</span>
            <span className="glass px-3 py-1.5 rounded-full text-sm font-medium text-blue-600 dark:text-blue-400 border border-blue-500/20">Function Calling</span>
            <span className="glass px-3 py-1.5 rounded-full text-sm font-medium text-purple-600 dark:text-purple-400 border border-purple-500/20">Streaming</span>
            <span className="glass px-3 py-1.5 rounded-full text-sm font-medium text-orange-600 dark:text-orange-400 border border-orange-500/20">Embeddings</span>
          </div>
        </div>
